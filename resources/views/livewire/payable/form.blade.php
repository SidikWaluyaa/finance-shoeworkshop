        ...
        <div class="modal-content" @click.outside="$wire.closeModal()">
            <div class="flex items-center justify-between mb-4">
                <h3 class="text-lg font-bold text-[var(--color-dark)] dark:text-white">
                    {{ $payableId ? 'Edit Utang' : 'Tambah Utang' }}
                </h3>
            ...
            <form wire:submit="save" class="space-y-4">
                <div>
                    ...
                    <input type="text" wire:model="supplier_name" class="form-input @error('supplier_name') form-input-error @enderror" placeholder="PT Supplier ABC">
                    @error('supplier_name') <span class="error-msg"><svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z"/></svg>{{ $message }}</span> @enderror
                </div>
                ...
                <div>
                    ...
                    <textarea wire:model="description" class="form-input" rows="2" placeholder="Keterangan utang..."></textarea>
                </div>
