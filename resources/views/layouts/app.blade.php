...
>
    ...
    <aside class="fixed top-0 left-0 h-full z-50 w-64 flex flex-col transform transition-transform duration-200 ease-out border-r"
        ...
        <nav class="flex-1 px-3 py-5 space-y-0.5 overflow-y-auto">
            ...
            <a href="{{ route('users') }}"
               class="sidebar-link {{ request()->routeIs('users') ? 'active' : '' }}" @click="sidebarOpen = false">
        ...
        <div class="px-5 py-3 border-t flex-shrink-0"
            ...
            <div class="flex items-center gap-3">
                <div class="w-8 h-8 rounded-full bg-[var(--color-primary)]/20 flex items-center justify-center text-[var(--color-primary)] font-bold text-xs">
            ...
            <p class="text-[8px] mt-3 opacity-40">© 2026 Shoeworkshop Finance</p>
        </div>
    </aside>
