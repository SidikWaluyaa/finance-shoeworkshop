...
>
    ...
    <aside class="fixed top-0 left-0 h-full z-50 flex flex-col transform transition-all duration-300 ease-in-out border-r"
        ...
        <nav class="flex-1 px-3 py-6 space-y-1 overflow-y-auto overflow-x-hidden scrollbar-none custom-scrollbar">
            ...
            <a href="{{ route('dashboard') }}" wire:navigate class="sidebar-link {{ request()->routeIs('dashboard') ? 'active' : '' }}" :class="sidebarCollapsed ? 'justify-center px-0 h-12 rounded-xl' : 'px-4 py-3 rounded-xl gap-3'">
            ...
            <a href="{{ route('transactions') }}" wire:navigate class="sidebar-link {{ request()->routeIs('transactions') ? 'active' : '' }}" :class="sidebarCollapsed ? 'justify-center px-0 h-12 rounded-xl' : 'px-4 py-3 rounded-xl gap-3'">
                <div class="shrink-0 w-5 h-5 flex items-center justify-center">
            ...
            <a href="{{ route('invoices') }}" wire:navigate class="sidebar-link {{ request()->routeIs('invoices') ? 'active' : '' }}" :class="sidebarCollapsed ? 'justify-center px-0 h-12 rounded-xl' : 'px-4 py-3 rounded-xl gap-3'">
                <div class="shrink-0 w-5 h-5 flex items-center justify-center">
            ...
            <a href="{{ route('rabs') }}" wire:navigate class="sidebar-link {{ request()->routeIs('rabs') ? 'active' : '' }}" :class="sidebarCollapsed ? 'justify-center px-0 h-12 rounded-xl' : 'px-4 py-3 rounded-xl gap-3'">
                <div class="shrink-0 w-5 h-5 flex items-center justify-center">
            ...
            <a href="{{ route('payables') }}" wire:navigate class="sidebar-link {{ request()->routeIs('payables') ? 'active' : '' }}" :class="sidebarCollapsed ? 'justify-center px-0 h-12 rounded-xl' : 'px-4 py-3 rounded-xl gap-3'">
                <div class="shrink-0 w-5 h-5 flex items-center justify-center">
            ...
            <a href="{{ route('expense-locations') }}" wire:navigate class="sidebar-link {{ request()->routeIs('expense-locations') ? 'active' : '' }}" :class="sidebarCollapsed ? 'justify-center px-0 h-12 rounded-xl' : 'px-4 py-3 rounded-xl gap-3'">
                <div class="shrink-0 w-5 h-5 flex items-center justify-center">
            ...
            <a href="{{ route('accounts') }}" wire:navigate class="sidebar-link {{ request()->routeIs('accounts') ? 'active' : '' }}" :class="sidebarCollapsed ? 'justify-center px-0 h-12 rounded-xl' : 'px-4 py-3 rounded-xl gap-3'">
                <div class="shrink-0 w-5 h-5 flex items-center justify-center">
            ...
            <a href="{{ route('categories') }}" wire:navigate class="sidebar-link {{ request()->routeIs('categories') ? 'active' : '' }}" :class="sidebarCollapsed ? 'justify-center px-0 h-12 rounded-xl' : 'px-4 py-3 rounded-xl gap-3'">
                <div class="shrink-0 w-5 h-5 flex items-center justify-center">
            ...
            <a href="{{ route('users') }}" wire:navigate class="sidebar-link {{ request()->routeIs('users') ? 'active' : '' }}" :class="sidebarCollapsed ? 'justify-center px-0 h-12 rounded-xl' : 'px-4 py-3 rounded-xl gap-3'">
                <div class="shrink-0 w-5 h-5 flex items-center justify-center">
            ...
            <a href="{{ route('trash') }}" wire:navigate class="sidebar-link {{ request()->routeIs('trash') ? 'active' : '' }}" :class="sidebarCollapsed ? 'justify-center px-0 h-12 rounded-xl' : 'px-4 py-3 rounded-xl gap-3'">
                <div class="shrink-0 w-5 h-5 flex items-center justify-center">
    ...
    <nav class="lg:hidden fixed bottom-0 left-0 right-0 z-40 safe-area-bottom border-t"
        ...
        <div class="flex items-center justify-around h-16 px-2">
            <a href="{{ route('dashboard') }}" wire:navigate class="bottom-nav-item {{ request()->routeIs('dashboard') ? 'active' : '' }}">
            ...
            <a href="{{ route('transactions') }}" wire:navigate class="bottom-nav-item {{ request()->routeIs('transactions') ? 'active' : '' }}">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 16V4m0 0L3 8m4-4l4 4m6 0v12m0 0l4-4m-4 4l-4-4"/></svg>
                <span>Transaksi</span>
            </a>
            <a href="{{ route('invoices') }}" wire:navigate class="bottom-nav-item {{ request()->routeIs('invoices') ? 'active' : '' }}">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/></svg>
                <span>Piutang</span>
            </a>
            <a href="{{ route('rabs') }}" wire:navigate class="bottom-nav-item {{ request()->routeIs('rabs') ? 'active' : '' }}">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 7h6m0 10v-3m-3 3h.01M9 17h.01M9 14h.01M12 14h.01M15 11h.01M12 11h.01M9 11h.01M7 21h10a2 2 0 002-2V5a2 2 0 00-2-2H7a2 2 0 00-2 2v14a2 2 0 002 2z"/></svg>
                <span>RAB</span>
            </a>
            <a href="{{ route('expense-locations') }}" wire:navigate class="bottom-nav-item {{ request()->routeIs('expense-locations') ? 'active' : '' }}">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"/></svg>
                <span>Lokasi</span>
            </a>
            <a href="{{ route('accounts') }}" wire:navigate class="bottom-nav-item {{ request()->routeIs('accounts') ? 'active' : '' }}">
